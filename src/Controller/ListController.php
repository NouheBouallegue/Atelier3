    ...
    public function list()
{
    ...
    return $this->render('list.html.twig',['formations'=>$formations]);
}
#[Route('/nom/{nom}', name: 'nom')] 
public function nom($nom):Response
{ 
    return $this->render('detail.html.twig',['nom'=>$nom]);
}
}
